...
namespace SSLightningRod
{
	...
	public static class WeatherEvent_LightningRodStrike
    {
        ...
        {
            if (!_state_) GenExplosion.DoExplosion(center, map, radius, damType, instigator, damAmount, armorPenetration, explosionSound, weapon, projectile, intendedTarget, postExplosionSpawnThingDef, postExplosionSpawnChance, postExplosionSpawnThingCount, applyDamageToExplosionCellsNeighbors, preExplosionSpawnThingDef, preExplosionSpawnChance = 0f, preExplosionSpawnThingCount, chanceToStartFire, damageFalloff);
        }
